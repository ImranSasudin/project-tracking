            ...
            <div class="col-sm-5">
                ...
                <div class="card card-primary">
                 ...
                 <div class="card card-primary">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form role="form" action="{{ route('admin.project.file.update') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" name="id" value="{{ $project->id }}">
                        <div class="card-body">
                            <ol>
                                @foreach($files as $file)
                                <li><a href="{{ '/storage/'.$file->file_path }}" target="_blank">{{ $file->file_name }}<a/><a href="{{ route('admin.project.file.delete', $file->id) }}" class="badge badge-danger ml-2">Delete</a></li>
                                @endforeach
                            </ol>
                            <div class="form-group">
